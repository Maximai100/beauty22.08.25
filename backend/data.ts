...
export const getInitialData = (): LandingPageData => ({
  ...
  clients: [
    { id: '1', name: 'Анна Иванова', phone: '+7-912-345-67-89', email: 'anna.i@example.com', notes: 'Предпочитает светло-розовый лак.', visitHistory: [new Date().toISOString()] },
    { id: '2', name: 'Елена Смирнова', phone: '+7-923-456-78-90', email: 'elena.s@example.com', notes: 'Аллергия на латекс.', visitHistory: [new Date(Date.now() - 86400000 * 10).toISOString()] },
  ],
  contact: {
